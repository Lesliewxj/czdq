	...
	<div class="content">
		<div class="container">
			...
			<div class="f-r span658">
				<div class="titlebox"><h2 class="f-l">新闻资讯</h2><a class="f-r" href="#">&nbsp;</a></div>
				<div class="about">
				     <div><c:out value="${requestScope.xinwen.biaoti}" escapeXml="false"></c:out></div>
	                 <%-- <div style="margin-top: 8px;"><img style="border:1px solid  #CCCCCC;" src="<%=path %>/${xinwen.fujian }" height="300" width="600"/></div> --%>
	                 <div style="margin-top: 8px;"><c:out value="${requestScope.xinwen.jieshao}" escapeXml="false"></c:out></div>
	                 ...
	                 <div style="margin-top: 8px;">发布时间：<c:out value="${requestScope.xinwen.fabushi}" escapeXml="false"></c:out></div>   
				</div>
			</div>
			<!-- right -->
			<div class="clear"></div>
