...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           function tejiaShezhi(id)
           {
               if(confirm('您确定设置特价吗？'))
               {
                   window.location.href="<%=path %>/admin/goods/tejiaShezhi.jsp?id="+id;
               }
           }
           ...
           function pinglunMana(goods_id)
           {
                 var url="<%=path %>/pinglun?type=pinglunMana&goods_id="+goods_id;
				 window.location.href=url;
           }
       </script>
	</head>
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF">
					...
					<td bgcolor="#FFFFFF" align="center"><a href="#" onclick="goodsDetailHou(${goods.id})" class="pn-loperator">简单介绍</a></td>
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<input type="button" value="评论管理" onclick="pinglunMana(${goods.id})"/>
					</td>
				</tr>
				</c:forEach>
			</table>
		    ...
		    <table width='98%'  border='0'style="margin-top:8px;margin-left: 11px;">
			  <tr>
			    <td>
			      <input type="button" value="添加商品信息" style="width: 120px;" onclick="goodsAdd()" />
			    </td>
			  </tr>
		    </table>
		    ...
		    <div id="tip" style="position:absolute;display:none;border:0px;">
				<TABLE id="tipTable" border="0" bgcolor="#ffffee">
					<TR align="center">
						<TD><img id="photo" src="" height="150" width="160"></TD>
					</TR>
				</TABLE>
			</div>
	</body>
