			...
			<form action="<%=path %>/goods?type=goodsAdd" name="formAdd" method="post">
				     <table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
						...
						<tr align='center' bgcolor="#FFFFFF" height="33">
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <table border="0">
							           <tr> 
							               <td>  
							                  <select name="catelog_id" id="catelog_id" style="width: 280px;" onclick="catelogAll()">
						...
						<tr align='center' bgcolor="#FFFFFF" height="33">
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <FCK:editor instanceName="jieshao"  basePath="/fckeditor" width="900" height="140" value="" toolbarSet="Basic">
	                            </FCK:editor>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" height="33">
						...
						<tr align='center' bgcolor="#FFFFFF" height="33">
						    ...
						    <td width="90%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="shichangjia" value="10" style="width: 280px;" onpropertychange="onchange1(this.value)" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" height="33">
						    <td width="10%" bgcolor="#FFFFFF" align="right">
